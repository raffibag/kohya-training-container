#!/usr/bin/env python3
"""Start SD inference SageMaker endpoint"""
...
IMAGE_URI = "796245059390.dkr.ecr.us-west-2.amazonaws.com/stable-diffusion-inference:ultra-lean"
...
def main():
    ...
    try:
        ...
        # Create model
        model_name = f"sd-inference-model-{timestamp}"
        ...
        sagemaker.create_model(
            ...
            PrimaryContainer={
                ...
                'Environment': {
                    'SAGEMAKER_PROGRAM': 'controlnet_lora_handler.py',
        ...
        config_name = f"sd-inference-config-{timestamp}"
